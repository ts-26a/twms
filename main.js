...
function _main() {
    if (location.href.match(/.*\/status\/[0-9]+/) != null) {
        let tweet = document.querySelector(`#react-root > div > div > div > main > div > div > div > div > div > div:nth-child(2) > div > section > div > div > div > div > div > article > div > div > div > div:nth-child(3) > div > div > div > a:nth-child(1) > span`);
        if (tweet != null) {
